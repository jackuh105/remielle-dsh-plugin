...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // ---- settings card (settings.plugin.item slot) ----
    // Visual chrome mirrors the shipped PluginCard (border, radius, paddings)
    // so the card aligns with the official ones; persistence stays local.
    ...
    function SettingsCard() {
      ...
      var bodyStyle = {
        borderTop: "1px solid var(--dsw-alias-border-l2, rgba(255,255,255,0.12))",
        margin: "0 16px", padding: "12px 0 16px",
      };
      function Chevron() {
        ...
        children: [
          jsxRuntime.jsx("button", {
            ...
            style: {
              ...
              border: 0, borderRadius: 12, alignItems: "center", gap: 12,
            ...
            children: [
              jsxRuntime.jsx("span", {
                ...
                children: [
                  jsxRuntime.jsx("div", { style: nameStyle, children: "Remielle 桌寵" }),
                  jsxRuntime.jsx("div", {
                    style: descStyle,
    ...
    function apply(ctx) {
      ...
      ctx.effect(function () {
        return ctx.slots.inject("settings.plugin.item", function () {
          return ctx.slots.register({ name: "settings.plugin.item", id: "remielle-settings", order: 100 }, SettingsCard);
        });
